...
MASTER_TIER = {
    ...
    12: {
        # ✅ green tick  = chaos log filled + incident report generated by agents
        "core": [
            "chaos_log.md",                      # Phase 2 investigation + Phase 3 judgment answers
            "agent_outputs/incident_report.md",  # Phase 3 — supervisor agent ran successfully
        ],
        # 👑 gold crown  = above 2 + forensics extension tested (creates this file)
        "extra": [
            "agent_outputs/forensics_extension.json",  # Step 22 — python lab/tools/check_cloudwatch.py --test
        ],
    },
    13: {
        "core": [
            "agent_outputs/mystery_guess.json",    # Lab 1 — manual answers saved
            "agent_outputs/catalogue_sigma.json",  # Lab 2 — client deliverable
        ],
        "extra": [],
    },
}
...
EXPECTED_FILES = {
    ...
    12: {
        "chaos_log.md":                              "ChaosLog",
        "agent_outputs/incident_report.md":          "Incident",
        "agent_outputs/forensics_extension.json":    "Extension",
    },
    13: {
        "agent_outputs/mystery_guess.json":          "Guess",
        "agent_outputs/catalogue_sigma.json":        "SigmaCat",
    },
}
